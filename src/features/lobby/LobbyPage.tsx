    ...
    <div className="page">
      <div className="between" style={{ flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <div className="page-sub">Hosted by you  -  region Auto  -  est. start in 30s</div>
        </div>
  ...
  return (
    <div className="surface mobile-wrap" style={{ padding: 14, display: 'flex', alignItems: 'center', gap: 12, minHeight: 80, borderColor: slot.ready ? 'rgba(52,211,153,0.25)' : 'var(--border-2)' }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div className="mono" style={{ fontSize: 11, color: 'var(--text-lo)' }}>{isAi ? 'Difficulty: Hard' : `Seat ${seat}  -  Auto`}</div>
      </div>
